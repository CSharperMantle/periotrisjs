...
/* harmony export */   "PlayAreaHeight": () => (/* binding */ PlayAreaHeight),
/* harmony export */   "PlayAreaWidth": () => (/* binding */ PlayAreaWidth),
/* harmony export */   "GameUpdateIntervalMilliseconds": () => (/* binding */ GameUpdateIntervalMilliseconds)
/* harmony export */ });
const PlayAreaHeight=11;const PlayAreaWidth=18;const GameUpdateIntervalMilliseconds=1000;
...
/***/ "./src/model/generation/GeneratorHelper.ts":
/*!*************************************************!*\
  !*** ./src/model/generation/GeneratorHelper.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createOffsetedBlocks": () => (/* binding */ createOffsetedBlocks),
/* harmony export */   "getFirstBlockCoordByType": () => (/* binding */ getFirstBlockCoordByType),
/* harmony export */   "getFirstBlockPositionByPosition": () => (/* binding */ getFirstBlockPositionByPosition),
/* harmony export */   "getPositionByFirstBlockPosition": () => (/* binding */ getPositionByFirstBlockPosition),
...
/***/ "./src/model/generation/MessageType.ts":
/*!*********************************************!*\
  !*** ./src/model/generation/MessageType.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/model/generation/PatternGenerator.ts":
/*!**************************************************!*\
  !*** ./src/model/generation/PatternGenerator.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var lodash_some__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/some */ "./node_modules/lodash/some.js");
/* harmony import */ var lodash_some__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_some__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _DependencyBuilder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DependencyBuilder */ "./src/model/generation/DependencyBuilder.ts");
function sort(tetriminos,playAreaWidth,playAreaHeight){const graph=(0,_DependencyBuilder__WEBPACK_IMPORTED_MODULE_1__.createTetriminoDependencyGraph)(tetriminos,playAreaWidth,playAreaHeight);const startNodes=[];graph.forEach(node=>{if(node.depending.size===0){startNodes.push(node);}});const result=[];while(startNodes.length!==0){const n=startNodes.pop();result.push(n);const dependedBy=[...n.dependedBy];dependedBy.forEach(m=>{n.dependedBy.delete(m);m.depending.delete(n);if(m.depending.size===0){startNodes.push(m);}});}if(lodash_some__WEBPACK_IMPORTED_MODULE_0___default()(graph,node=>node.dependedBy.size!==0||node.depending.size!==0)){throw new RangeError("tetriminos");}return result;}
...
"use strict";
/*!***********************************************************************************************************************************!*\
  !*** ./node_modules/gatsby/dist/utils/babel-loader.js??ruleSet[1].rules[10].use!./src/model/generation/PatternGeneratorWorker.ts ***!
  \***********************************************************************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
const ctx=self;ctx.onmessage=eventArgs=>{const data=eventArgs.data;switch(data.type){case _MessageType__WEBPACK_IMPORTED_MODULE_0__.MessageType.RequestGeneration:const tetriminos=(0,_PatternGenerator__WEBPACK_IMPORTED_MODULE_1__.getPlayablePattern)();const message={type:_MessageType__WEBPACK_IMPORTED_MODULE_0__.MessageType.ResponseSuccess,content:tetriminos};ctx.postMessage(message);break;default:console.warn(data.type);break;}};
})();
